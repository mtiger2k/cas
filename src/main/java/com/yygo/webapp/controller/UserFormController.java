...
public class UserFormController extends BaseFormController {
    ...
    protected List<LabelValue> loadAvailableRoles() {
        ...
        list.add(new LabelValue(getText(Constants.ADMIN_ROLE, LocaleContextHolder.getLocale()), Constants.ADMIN_ROLE));
        list.add(new LabelValue(getText(Constants.USER_ROLE, LocaleContextHolder.getLocale()), Constants.USER_ROLE));
        return list;
    }
}
